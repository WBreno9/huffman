...
std::vector<uint8_t> HCompressor::compress_data(const std::vector<uint8_t>& data) {
...
std::vector<uint8_t> HCompressor::uncompress_data(const std::vector<uint8_t>& data) {
    std::array<uint32_t, CodeNum> freqs = {0};
...
std::vector<uint8_t> HCompressor::compress_file(const std::string& file_path) {
...
std::vector<uint8_t> HCompressor::uncompress_file(const std::string& file_path) {
    ...
    return uncompress_data(data);
}

void HCompressor::compress_file_write(const std::string& file_path, const std::string& write_file_path) {
